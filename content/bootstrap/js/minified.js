...
(function () {
    ...
    WebSocket.__initialize = function () {
        ...
        swfobject.embedSWF(WEB_SOCKET_SWF_LOCATION, "webSocketFlash", "1", "1", "10.0.0", null, null, {hasPriority:true, swliveconnect:true, allowScriptAccess:"always"}, null, function (f) {
            if (!f.success) {
...
!function (b) {
    ...
    f.prototype = {constructor:f, close:function (a) {
        function g() {
            h.remove(), h.trigger("closed")
        }

        var j = e(this), i = j.attr("data-target"), h;
        i || (i = j.attr("href"), i = i && i.replace(/.*(?=#[^\s]*$)/, "")), h = e(i), h.trigger("close"), a && a.preventDefault(), h.length || (h = j.hasClass("alert") ? j : j.parent()), h.removeClass("in"), e.support.transition && h.hasClass("fade") ? h.on(e.support.transition.end, g) : g()
    ...
    c.prototype = {constructor:c, setState:function (g) {
        ...
        d("body").on("click.button.data-api", "[data-toggle^=button]", function (a) {
            d(a.target).button("toggle")
        })
    })
}(window.jQuery), !function (d) {
    var c = function (a, e) {
        this.$element = d(a), this.options = d.extend({}, d.fn.carousel.defaults, e), this.options.slide && this.slide(this.options.slide)
    };
    c.prototype = {cycle:function () {
        ...
        return this.sliding = !0, m && this.pause(), n = n.length ? n : this.$element.find(".item")[k](), !d.support.transition && this.$element.hasClass("slide") ? (this.$element.trigger("slide"), o.removeClass("active"), n.addClass("active"), this.sliding = !1, this.$element.trigger("slid")) : (n.addClass(a), n[0].offsetWidth, o.addClass(l), n.addClass(l), this.$element.trigger("slide"), this.$element.one(d.support.transition.end, function () {
    ...
    }, d.fn.carousel.defaults = {interval:5000}, d.fn.carousel.Constructor = c, d(function () {
    ...
    c.prototype = {constructor:c, dimension:function () {
        ...
        this.$element.removeClass("collapse")[e](f || "auto")[0].offsetWidth, this.$element.addClass("collapse")
    ...
    h.prototype = {constructor:h, toggle:function (a) {
    ...
    "use strict";
    var h = function (a, d) {
        this.options = i.extend({}, i.fn.modal.defaults, d), this.$element = i(a).delegate('[data-dismiss="modal"]', "click.dismiss.modal", i.proxy(this.hide, this))
    };
    h.prototype = {constructor:h, toggle:function () {
        ...
        return this.each(function () {
            var g = i(this), c = g.data("modal"), b = typeof a == "object" && a;
            c || g.data("modal", c = new h(this, b)), typeof a == "string" ? c[a]() : c.show()
        })
    }, i.fn.modal.defaults = {backdrop:!0, keyboard:!0}, i.fn.modal.Constructor = h, i(function () {
    ...
    c.prototype = {constructor:c, init:function (a, j, i) {
        var h, g;
        ...
        return a = d.extend({}, d.fn[this.type].defaults, a, this.$element.data()), a.delay && typeof a.delay == "number" && (a.delay = {show:a.delay, hide:a.delay}), a
    }, enter:function (a) {
        ...
        return d.extend({}, a ? {top:0, left:0} : this.$element.offset(), {width:this.$element[0].offsetWidth, height:this.$element[0].offsetHeight})
    }, getTitle:function () {
    ...
    }, d.fn.tooltip.Constructor = c, d.fn.tooltip.defaults = {animation:!0, delay:0, selector:!1, placement:"top", trigger:"hover", title:"", template:'<div class="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>'}
}(window.jQuery), !function (d) {
    var c = function (f, e) {
        this.init("popover", f, e)
    };
    c.prototype = d.extend({}, d.fn.tooltip.Constructor.prototype, {constructor:c, setContent:function () {
    ...
    "use strict", c.prototype = {constructor:c, refresh:function () {
    ...
    c.prototype = {constructor:c, show:function () {
        ...
        h = j.find(".active a").last()[0], a.trigger({type:"show", relatedTarget:h}), g = d(i), this.activate(a.parent("li"), j), this.activate(g, g.parent(), function () {
    ...
    c.prototype = {constructor:c, select:function () {
        ...
        return this.$element.val(b), this.hide()
    }, show:function () {
        ...
        var e = this;
        f.stopPropagation(), f.preventDefault(), setTimeout(function () {
            e.hide()
        }, 150)
    }, click:function (b) {
    ...
    }, d.fn.typeahead.defaults = {source:[], items:8, menu:'<ul class="typeahead dropdown-menu"></ul>', item:'<li><a href="#"></a></li>'}, d.fn.typeahead.Constructor = c, d(function () {
